...
local function git_summary(bufnr)
...
local function git_status(winid)
	local branch = git_branch()
	local hunks = git_summary(vim.api.nvim_win_get_buf)
...
function M.activeLine()
	...
	-- Component: Git
	statusline = statusline.."%#DirSeparator#"..left_separator.."%#GitStatus# "..git_status(0).."%#DirSeparator#"..right_separator
	statusline = statusline..blank
...
local InactiveLine_bg = color.darkgray
